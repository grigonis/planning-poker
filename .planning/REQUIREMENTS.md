...
### Architecture (ARCH)
- [x] **ARCH-01**: Room creation triggers via dedicated `/create` page instead of a modal.
- [x] **ARCH-02**: Landing page (`/`) serves exclusively as a marketing/entry index.
- [x] **ARCH-03**: Remove all legacy "split mode" averages and logic from backend and frontend.
- [x] **ARCH-04**: Navbar is modernized with additional options mirroring Kollabe functionality.
...
- [x] **TASK-05**: Modernized UI Settings menu (tailored to current app UI) for room configuration.
- [x] **TASK-06**: Spectator role retained exactly as is (can observe without participating).
