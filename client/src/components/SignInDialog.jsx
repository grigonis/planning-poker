...
// SVG icons inlined to avoid external icon deps for brand logos
const GoogleIcon = () => (
        ...
        <Dialog open={open} onOpenChange={(v) => { if (!v) onClose(); }}>
            <DialogContent className="sm:max-w-sm">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Sync your profile and history across devices. Your current guest session is unaffected.
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="flex flex-col gap-3 pt-2">
                    <Button
                        variant="outline"
                        className="h-11 rounded-xl gap-3 font-semibold"
