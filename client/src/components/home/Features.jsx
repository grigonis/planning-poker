    ...
    return (
        <section className="w-full max-w-7xl mx-auto px-6 py-20 relative z-10">
            <div className="mb-16 text-center">
                ...
                <p className="text-lg text-gray-400 font-light font-heading max-w-2xl mx-auto leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {featuresList.map((feature, index) => (
                    <div
                        key={index}
                        className="p-8 rounded-3xl bg-white/5 backdrop-blur-md border border-white/10 shadow-lg hover:bg-white/10 hover:border-banana-500/30 transition-all duration-300 flex flex-col items-center text-center group"
                    >
                        <div className="text-5xl mb-6 group-hover:scale-110 transition-transform duration-300">
                            {feature.icon}
                        </div>
                        <h3 className="text-xl font-bold font-heading text-white mb-3">{feature.title}</h3>
                        <p className="text-gray-400 font-light font-heading leading-relaxed text-sm">
                            {feature.description}
                        </p>
                    </div>
                ))}
