    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in duration-200">
            <div className="relative w-full max-w-md bg-white dark:bg-dark-800 border border-gray-200 dark:border-white/10 rounded-2xl shadow-2xl p-6 md:p-8 animate-in zoom-in-95 duration-200 transition-colors duration-300">
                ...
                {step === 1 && (
                    <>
                        <h2 className="text-2xl font-bold font-heading text-gray-900 dark:text-white mb-2">Join Session</h2>
                        ...
                        <form onSubmit={handleCheckRoom} className="space-y-6">
                            <div className="space-y-2">
                                <label className="text-sm font-bold font-heading text-gray-600 dark:text-gray-300">Room Code</label>
                ...
                {step === 2 && (
                    <>
                        <h2 className="text-2xl font-bold font-heading text-gray-900 dark:text-white mb-2">Join Room: {roomCode.toUpperCase()}</h2>
                        ...
                        <form onSubmit={handleJoin} className="space-y-6">
                            <div className="space-y-2">
                                <label className="text-sm font-bold font-heading text-gray-600 dark:text-gray-300">Display Name</label>
                                <div className="relative">
                                    <div className="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-400 dark:text-gray-500">
                                        <User size={18} />
                                    </div>
